...
(function() {
    ...
    const i18n = {
        ru: {
            ...
            empty: "База пуста. Убедитесь, что файл /data/db.json существует.",
        ...
        en: {
            ...
            empty: "Database empty. Make sure /data/db.json exists.",
    ...
    // Ссылки на PDF (корректные для вашей структуры)
