// script.js — UDREAM v13 (исправленный)
(function() {
    // --- состояние
    let db = [];
    ...
    const i18n = {
        ru: {
            ...
            empty: "База пуста. Загрузите JSON-файл через меню.",
        ...
        en: {
            ...
            empty: "Database empty. Upload JSON via menu.",
    ...
    function applyLocalization() {
        ...
        // обновить текст кнопки выделения
        ...
        reader.onload = function(e) {
            try {
                ...
                if (Array.isArray(data) && data.length) {
                    ...
                    buildAlphabetRows();          // перестроить алфавит
                    rebuildTagsCloud();           // обновить облако тегов
    ...
    // --- Алфавитные строки (латиница, кириллица, цифры + цвет)
    let groupedAll = {};
    ...
    function buildAlphabetRows() {
        ...
        function renderRow(container, letters, type, extraItems = []) {
            ...
            // добавить дополнительные элементы (например, Color)
    ...
    // --- Ссылки на PDF
    const repoBase = "/udream/";
    book1Link.href = repoBase + "The_Divinity_Code_to_Understanding_Your_Dreams_and_Visions_PDF_Room.pdf";
    book2Link.href = repoBase + "Unlocking-Your-Dream-Student-Ma.pdf";
    ...
    // --- Кнопка для открытия облака тегов
