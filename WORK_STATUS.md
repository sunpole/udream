...
|---|---|
| Состояние | **IN_PROGRESS** — исправляется повреждённое изображение, блокирующее FIFO-публикацию uNews |
...
| Активная задача | заменить невалидный файл изображения `23.8.0`, объединить hotfix и подтвердить Telegram-публикацию всей очереди |
...
- создана hotfix-ветка от актуального `main`;
...
- добавлено узкое PR-правило для `publication_repair: unpublished-invalid-image`;
...
- последний hotfix commit перед этим handoff: `f6ac19d7a4d7776451599f3917a8e1b0e426e0b3`.

Следующий точный шаг:

- усилить постоянный project validator для repair-marker, документировать исключение, открыть Pull Request, пройти GitHub Actions и объединить hotfix; затем повторно запустить uNews и проверить каждый Telegram checkpoint.
