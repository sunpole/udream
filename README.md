...
| Продолжить разработку с другого устройства | Сначала открыть [WORK_STATUS.md](WORK_STATUS.md), затем проверить указанную ветку и Pull Request |
...
| Документационный baseline | `v23.8.5` — единый журнал передачи работы между устройствами |
| Оперативная точка продолжения | [WORK_STATUS.md](WORK_STATUS.md) |
| Текущее состояние работы | `READY` — незавершённой активной задачи нет |
...
├── WORK_STATUS.md               # текущая задача и точка передачи между устройствами
...
- [Текущая точка работы между устройствами](WORK_STATUS.md)
